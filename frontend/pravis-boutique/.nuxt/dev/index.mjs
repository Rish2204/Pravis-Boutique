...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseStatus, setResponseHeader, send as send$1, getRequestHeaders, getRequestURL, getResponseHeader, setResponseHeaders, appendResponseHeader, removeResponseHeader, createError, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { renderSSRHead } from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/@unhead/ssr/dist/index.mjs';
import destr from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/destr/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash } from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/ufo/dist/index.mjs';
...
import consola from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/consola/dist/index.mjs';
...
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/unhead/dist/index.mjs';
import { unref, version } from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file:///home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/runner/work/Pravis-Boutique/Pravis-Boutique/frontend/pravis-boutique/server"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "appDescription": "Pravis Boutique E-commerce Platform",
    "appVersion": "1.0.0",
...
const _lazy_VAhFbk = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_VAhFbk, lazy: true, middleware: false, method: undefined },
  { route: '/products', handler: _lazy_VAhFbk, lazy: true, middleware: false, method: undefined },
  { route: '/products/**', handler: _lazy_VAhFbk, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_VAhFbk, lazy: true, middleware: false, method: undefined }
];
...
const event_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: event_post
});

const POST$1 = defineEventHandler(async (event) => {
  try {
...
const deleteData_delete = defineEventHandler(async (event) => {
  try {
    const body = await readBody(event);
...
const deleteData_delete$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: deleteData_delete
});

const exportData_post = defineEventHandler(async (event) => {
  try {
    const body = await readBody(event);
    if (!body || !body.sessionId) {
      throw createError({
...
const exportData_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: exportData_post
});
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Pravis Boutique E-commerce Platform"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Pravis Boutique"};
