  ...
  <div>
        ...
        <div class="mt-16 border-t border-gray-200 dark:border-gray-700">
          ...
          <div v-if="activeTab === 'description'" class="py-6">
            <div class="prose prose-sm max-w-none text-gray-700 dark:text-gray-300">
              <p v-if="!product.fullDescription">
                {{ product.description }}
              </p>
            ...
            <div v-if="product.reviews && product.reviews.length > 0">
              ...
              <div class="space-y-8">
                ...
                >
                  ...
                  <div class="mt-4">
                    <h5 v-if="review.title" class="text-sm font-medium text-gray-900 dark:text-white">
                      {{ review.title }}
                    </h5>
    ...
    >
      <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 bg-black bg-opacity-50 transition-opacity" @click="closeQuickView" />
