    ...
    >
      <div class="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl">
        <div class="flex items-center mb-4">
          <svg class="w-6 h-6 text-pravis-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
          </svg>
          <h3 class="text-lg font-semibold text-pravis-800 font-display">Privacy First Analytics</h3>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-3">
          <button 
            ...
            class="flex-1 bg-pravis-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-pravis-700 transition-colors"
          >
            Accept Analytics
          </button>
          <button 
